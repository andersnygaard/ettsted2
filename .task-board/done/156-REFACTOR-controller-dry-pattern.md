...
- [x] userController.ts
- [x] accountController.ts
- [x] snapshotController.ts
- [x] calculatorController.ts
- [x] importController.ts
- [x] onboardingController.ts

## Status: COMPLETED

All controllers successfully refactored to use asyncHandler wrapper and error classes.
