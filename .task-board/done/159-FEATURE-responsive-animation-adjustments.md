...
## Acceptance Criteria
- [x] Reduce translateY values on mobile (e.g., -4px → -2px)
- [x] Shorten animation durations on mobile
- [x] Test performance on mobile Safari
- [x] Ensure no animation-related jank during scroll
- [x] Touch feedback animations (button press, etc.)
