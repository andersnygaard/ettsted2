...
- [ ] Jest + React Testing Library configured in frontend workspace
- [ ] Test utilities for mocking TanStack Query
- [ ] Unit tests for all 5 high-priority hooks
- [ ] Tests cover calculation edge cases (zero values, negative, large numbers)
- [ ] Tests cover loading/error states
- [ ] Minimum 70% coverage on tested hooks
