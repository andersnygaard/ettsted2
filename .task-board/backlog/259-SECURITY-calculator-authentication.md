...
- [ ] All calculator endpoints require authentication
- [ ] Unauthenticated requests return 401
- [ ] Rate limiting still applies per-user (not per-IP)
- [ ] E2E calculator tests updated with auth
- [ ] Frontend calculator pages work with auth
