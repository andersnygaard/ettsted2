# 126-FEATURE: Modal Transition Improvements
...
- [ ] Modal scales from 95% to 100% while fading in
- [ ] Exit animation plays before DOM removal
- [ ] Animation duration: 200-300ms
- [ ] Keyboard close (Escape) triggers exit animation
- [ ] Click outside triggers exit animation
